# Jayesh Vishwakarma 🎧
AI/Backend Intern exploring the intersection of Generative AI and robust backend systems. Grinding LeetCode and making tech videos to learn in public.
...
<p>
  <a href="https://www.instagram.com/jeyy.sh/" target="_blank" rel="noopener noreferrer">
...
Generative AI & LLM:
LangChain, RAG Pipelines, Vector Databases, LLM Integration

Backend & APIs:
FastAPI, Django, REST APIs

MLOps & Deployment / Cloud:
Google Cloud (GCP — Cloud Run, Vertex AI), Docker, Streamlit, Vercel
